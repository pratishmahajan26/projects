# -*- coding: utf-8 -*-
"""
Created on Wed Jan 22 22:11:26 2020
...
rf = XGBRegressor(random_state=42,silent=True)
linear= LinearRegression()
# Random search of parameters, using 3 fold cross validation, 
# search across 100 different combinations, and use all available cores
rf_random = RandomizedSearchCV(estimator = rf, param_distributions = param_grid,cv= 3, n_jobs = -1)
...
new_test_sample.to_csv('solution_combined.csv')
